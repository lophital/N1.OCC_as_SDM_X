...
bioclim
names(bioclim) <- c("bio01", "bio12", "bio16", "bio17", "bio05", "bio06", "bio07", "bio08")
Xs <- bioclim
Xs.name <- names(Xs)
```
...
```{r}
set.seed(1)
inequation <- abs((1/sqrt(2*pi)*(Xpop*apop_1+sigma_1))*exp(1)^(-(sample(Xs[[1]], 1)-mu_01)^2/2*((Xpop*apop_1+sigma_1))^2) +
              (1/sqrt(2*pi)*sigma_02)*exp(1)^(-(sample(Xs[[2]], 1)-mu_02)^2/2*(sigma_02)^2) - Xpop) < 0.00001 
Xpop[inequation] %>% length()
Xpop[inequation]
